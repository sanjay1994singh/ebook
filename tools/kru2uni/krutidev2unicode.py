...
# Local changes (2026-09-07): Python 3 UTF-8 CLI compatibility; preserve final
# halants in devotional/Sanskrit text. Original converter and GPLv3 attribution
# retained; see LICENSE.md and README.md in this directory.
...
k2u = [
   ...
   (u'<\xee', u'\u0922\u094d\u092f'),  #  <î  ->  ढ्य
   (u'\xee', u'\u094d\u092f'),  # Local: generic half-ya; verified against pilot भर्यौ / पर्यौ.
   (u'|', u'\u0926\u094d\u092f'),  #  |  ->  द्य
   (u'K', u'\u091c\u094d\u091e'),  #  K  ->  ज्ञ
   (u'}', u'\u0926\u094d\u0935'),  #  }  ->  द्व
   (u'J', u'\u0936\u094d\u0930'),  #  J  ->  श्र
...
def kru2uni(kru_text):
    ...
    # Preserve terminal halants rather than silently editing Sanskrit words.
