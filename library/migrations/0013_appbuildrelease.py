    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("artifact_url", models.URLField(blank=True, help_text="Optional direct APK/AAB URL for testing releases.")),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["platform", "channel", "is_active", "-version_code"], name="app_release_lookup_idx"),
        ),
    ]
